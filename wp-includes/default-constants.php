...
function wp_initial_constants() {
	...
	if ( !defined('WP_CONTENT_DIR') )
		define( 'WP_CONTENT_DIR', ABSPATH . 'assets' ); // no trailing slash, full paths only - WP_CONTENT_URL is defined further down
...
function wp_plugin_directory_constants() {
	if ( !defined('WP_CONTENT_URL') )
		define( 'WP_CONTENT_URL', get_option('siteurl') . '/assets'); // full url - WP_CONTENT_DIR is defined further up
	...
	if ( !defined('PLUGINDIR') )
		define( 'PLUGINDIR', 'assets/plugins' ); // Relative to ABSPATH. For back compat.
